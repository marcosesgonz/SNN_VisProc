...
class EventPreprocessor:
    ...
    def __init__(self, options,DeviceTimer):
        self.DeviceTimer = DeviceTimer
...
class ImageWriter:
    ...
    def __init__(self, options):
        ...
        self.save_pngimg = options.save_images_in_png
        ...
        if self.output_folder:
            ...
            if self.save_pngimg:
                ...
                #print('Writing images to: {}'.format(join(self.output_folder, self.dataset_name)))
            ...
            if self.save_events:
                ...
                print('Writing event previews to: {}'.format(self.event_previews_folder))
    ...
    def __cleanup__(self):
        if self.output_folder and self.save_pngimg:
