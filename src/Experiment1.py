...
#OJO
#la carpeta que antes se llamaba Datasets ahora se llama data
#la carpeta que antes se llamaba projects ahora se llama src
...
if __name__ == '__main__':
    ...
    with wandb.init(project="Experimento1", name='DVSGesture_dataset',config=hyperparameters):
        net.to(device)
        ...
        max_test_acc = -1
        out_dir = os.path.join(os.getcwd(), f'T{T}_b{batch_size}_lr{lr}')
