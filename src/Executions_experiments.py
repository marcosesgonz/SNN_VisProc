...
if __name__ == '__main__':
    #execute_experiment_TrTstSplit(project_ref = 'Experimento1', name_experim = 'DVSDailyAct_b2_byexpdecay_T26', T = 26, splitby = 'exp_decay', batch_size = 2, epochs = 65, device = 'cuda',
