...
if __name__ == '__main__':
    execute_experiment_kfold(project_ref = 'ExperimentKFolds', name_experim = 'MAD_b2_video_T22_RANN_prueba', T = 22, batch_size = 2, epochs = nepochs,data_type='video',net_name='DVSG_RANN',softm=False,
