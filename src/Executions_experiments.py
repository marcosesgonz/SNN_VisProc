...
if __name__ == '__main__':
    ...
    #                         splitby='exp_decay',net_name='resnet18',resnet_pretrained=False, lr = 0.1, inp_data = data_MAD, gpu=True)
    execute_experiment_TrTstSplit(project_ref = 'Experiments_MAD_TrTstSplit', name_experim = 'MAD_b2_byexpdecay_T22', T = 22, batch_size = 1, epochs = nepochs,data_type='frame',softm=False,splitby='exp_decay',
