...
if __name__ == '__main__':
    ...
    execute_experiment_kfold(project_ref = 'ExperimentKFolds', name_experim = 'Animals_b2_video_T22_ANN', T = 22, batch_size = 2, epochs = nepochs,data_type='video',net_name='DVSG_ANN',
